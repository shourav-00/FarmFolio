            ...
            {user ? (
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex items-center gap-4 p-4 bg-green-50 rounded-xl">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="font-semibold text-gray-900">{userStats.memberSince}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-white rounded-3xl shadow-2xl p-8 border border-green-100">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                        <div className="text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border border-green-100">
                                            <div className="text-2xl font-bold text-green-600 mb-2">{userStats.totalProducts}</div>
                                            <p className="text-sm text-gray-600">Total Products</p>
                                        </div>
                                        
                                        <div className="text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border border-green-100">
                                            <div className="text-2xl font-bold text-green-600 mb-2">{userStats.activeListings}</div>
                                            <p className="text-sm text-gray-600">Active Listings</p>
                                        </div>
                                        
                                        <div className="text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border border-green-100">
                                            <div className="text-2xl font-bold text-green-600 mb-2">{userStats.totalSales}</div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-white rounded-3xl shadow-2xl p-6 border border-green-100">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <button className="w-full flex items-center gap-3 p-4 bg-green-50 hover:bg-green-100 rounded-xl transition-all duration-300 text-left">
                                            <FaShieldAlt className="w-5 h-5 text-green-600" /> {/* Changed to FaShieldAlt */}
                                ...
                                <div className="bg-white rounded-3xl shadow-2xl p-6 border border-green-100">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                                            ...
                                            <p className="text-sm text-gray-700">Added new product "Organic Tomatoes"</p>
                                            <span className="text-xs text-gray-500 ml-auto">2 hours ago</span>
                                        </div>
                                        
                                        <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                                            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                            <p className="text-sm text-gray-700">Updated product quantity for "Fresh Carrots"</p>
                                            <span className="text-xs text-gray-500 ml-auto">1 day ago</span>
                                        </div>
                                        
                                        <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                                            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                                            <p className="text-sm text-gray-700">Received new order for "Farm Eggs"</p>
                ...
                <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100">
                    <div className="text-center bg-white rounded-3xl shadow-2xl p-12 max-w-md mx-4 border border-green-200">
                        ...
                        <p className="text-gray-600 text-lg mb-8">Please login to view your profile</p>
                        <Link href="/login">
