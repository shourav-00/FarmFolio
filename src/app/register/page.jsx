...
//   //     const response = await fetch('https://farmfolio-server-api.vercel.app/api/register', {
//   //       method: 'POST',
//   //       headers: {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://farmfolio-server-api.vercel.app/api/register",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          ...
          <div className="bg-black bg-opacity-40 backdrop-blur-sm min-h-[700px] flex items-center justify-center p-8">
            <div className="w-full max-w-sm">
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-transparent text-green-100">
